      ...
      >
        ...
        <div className="list-group-item">
          <div className="form-row">
            <div className="form-group col-6">
              ...
              <select
                value={newAgentState}
                onChange={(e) => setNewAgentState(e.target.value)}
              >
                {options.map((value, i) => (
                  <option>{value}</option>
                ))}
            ...
            <div className="form-group col-6">
              ...
              <input
                ...
                ref={register}
                type="text"
                onChange={(e) => setNewAgentList(e.target.value)}
              />
            </div>
          </div>
        </div>
        <div className="form-group">
          {isLoading ? (
            <button
              type="submit"
              className="btn-lg btn-danger btn-block-small button-padding"
            >
              Submitting ....
            </button>
          ) : (
            <button
              type="submit"
              className="btn-lg btn-primary btn-block-small button-padding"
            >
              Submit
            </button>
          )}
